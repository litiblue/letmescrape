...
class OldnavyProductSpider(ProductSpider):
    ...
    def get_ajax_url_for_list(self, url):
        ...
        ajax_url = "http://oldnavy.gap.com/resources/productSearch/v1/search?cid=%s" % cid
        return ajax_url
    ...
    def get_url_for_data(self, url):
        ...
        data_url = "http://oldnavy.gap.com/browse/productData.do?pid=%s&vid=%s" % (pid[0:6], vid)
        return data_url
