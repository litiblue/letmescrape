...
def test_product_not_in_sale(spider):
    ...
    assert product == {
        ...
        'images': [{
                       'normal_size': u'http://cdn.s7.disneystore.com/is/image/DisneyShopping/4975055251610?$yetidetail$',
